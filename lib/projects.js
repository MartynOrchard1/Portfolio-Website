...
export const skills = {
  ...
  'Tools & Platforms': ['Streamlit', 'Claude API', 'WordPress', 'Docker', 'REST APIs', 'Git/GitHub'],
...
export const featuredProject = {
  ...
  tags: ['Embedded Systems', 'ESP32', 'GPS / GNSS', 'Python', 'Streamlit', 'Claude API', 'Data Analysis'],
};
